...
public class ManagerSection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("MANAGER LOG-IN");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(100, 170, 720, 110);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(AdminBackEnd.ManagerLogin(jTextField1.getText(),jTextField2.getText())){
            if(Admin.condition==0){
                Admin.condition=0;
                new RegisterEmployee().setVisible(true);
                this.setVisible(false);
            }else if(Admin.condition==1){
                Admin.condition=0;
                new ChangeManagerAccount().setVisible(true);
                this.setVisible(false);
            }else if(Admin.condition==2){
                Admin.condition=0;
                new CheckTransactionRecord().setVisible(true);
                this.setVisible(false);
            }else if(Admin.condition==3){
                Admin.condition=0;
                new ChangeManagerAccount().setVisible(true);
                this.setVisible(false);
            }else if(Admin.condition==4){
                Admin.condition=0;
