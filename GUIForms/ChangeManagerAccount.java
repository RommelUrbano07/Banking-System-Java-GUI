 ...
 * @author Margaux
 */
public class ChangeManagerAccount extends javax.swing.JFrame {

    /**
     * Creates new form ChangeManagerAccount
     */
    public ChangeManagerAccount() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField5.setBounds(380, 300, 330, 40);
        ...
        jButton1.setBounds(480, 500, 110, 50);
        ...
        jLabel8.setFont(new java.awt.Font("Lucida Sans", 1, 55)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 204, 0));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("CHANGE MANAGER ACCOUNT");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(0, 170, 930, 110);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (jTextField2.getText().length() >= 7) {
                AdminBackEnd.ChangeManagerAccount(jTextField5.getText(), jTextField1.getText(), jTextField2.getText());
            ...
            Logger.getLogger(ChangeManagerAccount.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeManagerAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeManagerAccount().setVisible(true);
            }
        });
    }
