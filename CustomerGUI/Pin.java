...
public class Pin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton25.setBounds(30, 590, 110, 60);
        ...
        jLabel11.setBounds(350, 240, 210, 60);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            EncryptionQueue var = new EncryptionQueue();
            if(CustomerBackEnd.CustomerMenu(accountNumber.toString(),passcode.toString())){
                new ClientTransaction().setVisible(true);
                this.setVisible(false);
            }else{
                Client.accountNumber=new StringBuilder();
