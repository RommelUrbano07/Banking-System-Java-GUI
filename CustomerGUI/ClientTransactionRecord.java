 ...
 * @author Margaux
 */
public class ClientTransactionRecord extends javax.swing.JFrame {
public static String accountNumber=ClientTransaction.accountNumber;
    /**
     * Creates new form ClientTransactionRecord
     */
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(50, 220, 820, 350);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientTransactionRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientTransactionRecord().setVisible(true);
            }
        });
    }
